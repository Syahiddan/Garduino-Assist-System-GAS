	...
	<body>
		...
		<div class="container-fluid" style="margin-top: 50px">
				...
				<script>
					$(document).ready(function(){
						...
						$(".btn-area").on("click",function(){
							...
							window.location.href="worker-garden-area.php";
						});
			...
			<div class="container-fluid fixed-bottom">
				<div id="list-dev-plant" class="d-none"></div>
				<div id="add-div-plant" class="d-none"></div>
				<div id="update-div-plant" class="d-none"></div>
				<div class="row ">
					<div class="col-12 text-center ">
						<img src="asset/plant.png" class="btn-add-plant" height="80">
						
					</div>
				</div>
				<script>
					$(document).ready(function(){
						$("#list-dev-plant").load("worker-plant.php");	
						$("#add-div-plant").load("worker-addplant.php");
						$("#update-div-plant").load("worker-updateplant.php");
						$(".btn-add-plant").on("click",function(){
							if($("#list-dev-plant").hasClass("d-none"))
							{
								$("#list-dev-plant").removeClass("d-none");
							}
							else
							{
								$("#list-dev-plant").addClass("d-none");
							}
						});
					});
				</script>
