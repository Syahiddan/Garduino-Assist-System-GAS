...
<body>
	...
	<div class="container-fluid" style="margin-top: 50px">
		...
		<div class="col-12 text-center">
			<center><img class="mt-2" src="asset/logo.png" height="70px"></center>
			<p class="h5 mt-3" style="font-family: Lucida Handwriting; font-size: 16px; color: #455b19"><b> Welcome to </b></p>
			<p class="h5 mt-2" style="font-family: Century Gothic; color: #455b19"><b> Garduino Assist System </b></p>
		</div>
