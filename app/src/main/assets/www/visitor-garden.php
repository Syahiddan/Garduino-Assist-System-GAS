...
<body>
	...
	<?php include_once("src/visitor-toolbar.php");?>
	<div class="container-fluid" style="margin-top: 50px">

		<?php include_once("src/visitor-slider.php");?>
		<?php include_once("src/visitor-directory-bar.php");?>
		<div class="row " style="margin-top: 30px">
			<div class="text-center"><img class="tryimage" src="asset/map.png" height="412" width="356" usemap="#gardenmap"></div>
			<map name="gardenmap">
